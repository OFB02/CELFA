        ...
        <div className="footer-content">
          ...
          <div className="footer-section footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="#" className="social-link" aria-label="Research Gate">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path d="M19.586 0c.818 0 1.508.19 2.073.565.563.377.85.935.85 1.68 0 .565-.192 1.048-.573 1.442-.382.395-.904.59-1.564.59-.66 0-1.195-.198-1.608-.594-.412-.395-.618-.877-.618-1.442 0-.747.287-1.305.85-1.68C18.078.19 18.768 0 19.586 0zm.387 5.31c.397 0 .736.144.997.43.26.286.39.651.39 1.094v2.588c0 .708-.263 1.302-.788 1.781-.525.48-1.142.72-1.85.72s-1.326-.24-1.851-.72c-.525-.479-.787-1.073-.787-1.781V6.834c0-.443.13-.808.39-1.094.26-.286.6-.43.997-.43h.502z" fill="currentColor"/>
                  <path d="M12.864 8.79c-.458-.11-.939-.165-1.442-.165-2.256 0-4.111.905-5.564 2.714-1.453 1.81-2.18 4.13-2.18 6.962 0 2.876.715 5.22 2.145 7.034C7.253 27.15 9.165 28.058 11.42 28.058c1.464 0 2.732-.33 3.804-.99 1.073-.66 1.885-1.607 2.437-2.841.552-1.234.828-2.677.828-4.33 0-1.653-.276-3.093-.828-4.32-.552-1.227-1.364-2.168-2.437-2.823-1.072-.655-2.34-.982-3.804-.982-.503 0-.984.055-1.442.165-.458.11-.913.275-1.364.495v.662c.451-.22.906-.385 1.364-.495z" fill="currentColor"/>
                </svg>
              </a>
